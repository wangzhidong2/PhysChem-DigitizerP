...
| 电流传感器 | ACS712 | ESP32-S3 | 物理 | GPL-3.0 | [使用说明](传感器代码/电流传感器/README.md)（ACS712 5A/20A/30A 量程，AC/DC，零点校准） |
...
| **pyqtgraph** | GPU 加速、缩放/平移拖拽，鼠标悬停弹出标签显示时间与数值，适合高频数据实时监视 |
...
**pyserial 未安装时的表现**（程序不会崩溃，模拟器/BLE 模式不受影响）：
